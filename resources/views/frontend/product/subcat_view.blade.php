...
@section('title')
Easy Online Shop-Sub Category Wise Product
@endsection
@php
              ...
              <div class="sidebar-widget-body">
                <div class="accordion">
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapse{{ $category->id }}" data-toggle="collapse" class="accordion-toggle collapsed"> @if(session()->get('language') == 'bangla') {{ $category->category_name_ban }} @else {{ $category->category_name_eng }} @endif </a> </div>
                    <!-- /.accordion-heading -->
                ...
                @foreach($subcategories as $subcategory)
                        <ul>
                          <li><a href="{{ url('product/sub_cat/'.$subcategory->id.'/'.$subcategory->subcategory_slug_eng) }}">@if(session()->get('language') == 'bangla') {{ $subcategory->subcategory_name_ban }} @else {{ $subcategory->subcategory_name_eng }} @endif</a></li>
                        </ul>
                @endforeach
                      </div>
                      <!-- /.accordion-inner --> 
...
/
        @foreach($breadsubcat as $item)
 <span class="badge badge-danger" style="background: #FF0000">{{ $item->subcategory_name_eng }} </span>
