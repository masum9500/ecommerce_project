...
<div class="row">
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<div class="controls">
				<input type="text"  name="product_size_en" class="form-control" value="Small,Midium,Larg" data-role="tagsinput" required>
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<div class="controls">
				<input type="text"  name="product_size_ban" class="form-control" value="Small,Midium,Larg" data-role="tagsinput" required>
...
<div class="row">
	<div class="col-md-4">
		<div class="form-group">
			...
			<div class="controls">
				<input type="text"  name="product_color_en" class="form-control" value="Blue,Red,Black" data-role="tagsinput" required>
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<div class="controls">
				<input type="text"  name="product_color_ban" class="form-control" value="Blue,Red,Black" data-role="tagsinput" required>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="form-group">
			<h5>Thambnail Image <span class="text-danger">*</span></h5>
			<div class="controls">
